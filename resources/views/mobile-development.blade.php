...
@section('content')
<main id="main">
  <div class="header-bg page-area d-flex align-items-center" style="background-image: url(/img/banners/app-development.jpg)">
    <div class="container">
      <div class="container">
        <div class="header-title" data-aos="fade-up" data-aos-delay="100">
          <h2 class="m-0"><strong>Mobile app development</strong></h2>
          <h4><strong>Bespoke native app solutions</strong></h4>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 py-5" data-aos="zoom-in" data-aos-delay="100">
          ...
          <h6>
            Tarabostes software has evolved alongside the journey of mobile app development, from the very first apps, to today’s mobile-first world.
          </h6>
          <h6>
            Our greatest strength is our experience in delivering best-in-class mobile applications and the complex technology solutions used to integrate with your business systems.
          </h6>
          <h6>
            Our client work is testament to our proven track record of selecting and managing the right technology to deliver native, web and hybrid products for some of the world's most ambitious organisations.
          </h6>
          <h6>
            We focus on solving enterprise business problems with our agile software development teams. It isn't about where your customers access the solution, it's about realising a genuine return on investment. That's our sweet spot.
          </h6>
          <h6>
            Regardless of whether you need a set of native applications, a hybrid app or an application delivered in another web-based technology, we have the highly skilled developers to meet your needs. Whatever your requirements, we're here to help.
          </h6>
        </div>
      </div>
    </div>
  ...
  <div class="section-bg">
    <div class="container">
      <div class="row">
        <div class="col-xs-12 py-5" data-aos="zoom-in" data-aos-delay="100">
          <div class="section-headline">
            <h2>Talk to us about mobile app development</h2>
          </div>
          <h5 class="mt-5">
          ...
          <h6>
            With deep roots going all the way back to the very first smartphone, Tarabostes software’s greatest asset is our experience in delivering world-class apps, and the tech solutions that marry them together with business systems.
          </h6>
          <h6>
